    ...
    var
        ...
        P = PickerInstance.prototype = {
            ...
            start: function() {
                ...
                var suffix = SETTINGS.hiddenSuffix ? SETTINGS.hiddenSuffix : '_submit';
                P._hidden = SETTINGS.formatSubmit ? $( '<input type=hidden name=' + ELEMENT.name + suffix + ( $ELEMENT.data( 'value' ) ? ' value="' + PickerConstructor._.trigger( P.component.formats.toString, P.component, [ SETTINGS.formatSubmit, P.component.item.select ] ) + '"' : '' ) + '>' )[ 0 ] : undefined
